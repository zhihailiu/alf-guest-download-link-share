      ...
      <#if document??>
         ...
         <div id="${el}-body" class="document-links document-details-panel">
            ...
            <div class="panel-body">
               ...
               <#if guestDownloadLink??>
                   <h3 class="thin dark">${msg("guestdownloadlink.page.header")}</h3>
                   <div class="link-info">
                      <input id="${el}-page-guest-download" value="${guestDownloadLink}"/>
                      <a href="#" name=".onCopyLinkClick" class="${el} hidden">${msg("guestdownloadlink.page.copy")}</a>
                   </div>
               </#if>
            </div>
         </div>
